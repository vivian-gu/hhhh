...
public class RefreshableView extends LinearLayout implements OnTouchListener {
	...
	/**
	 * �ϴθ���ʱ����ַ�����������Ϊ SharedPreferences�ļ�ֵ
	 */
...
//		lastUpdateTime = preferences.getLong(UPDATED_AT + mId, -1);
	...
	private void refreshUpdatedAtValue() {
		lastUpdateTime = preferences.getLong(UPDATED_AT + mId, -1);
		System.out.println("Refresh View finish time:"+lastUpdateTime);
		
		preferences.edit()
		.putLong(UPDATED_AT + mId, lastUpdateTime).commit();
		...
		//3、存放数据
		editor.putLong("timepassed",timePassed);
		//4、完成提交
		editor.commit();
